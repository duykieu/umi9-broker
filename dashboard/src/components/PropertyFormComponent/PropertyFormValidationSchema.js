...
const PropertyFormValidationSchema = yup.object().shape({
  ...
  priceModel: yup.string("Chưa chọn đơn vị tính").required(),
  ...
  structure: yup
    .string("Thiếu thông tin kết cấu")
    .required("Thiếu thông tin kết cấu"),
  ...
  user: yup
    .string("Thiếu thông tin nhân viên")
    .required("Thiếu thông tin nhân viên"),
  firstContact: yup.string("Thiếu thông tin liên hệ").nullable(),
  secondContact: yup.string("Thiếu thông tin liên hệ").nullable(),
  commission: yup
    .string("Thiếu thông tin hoa hồng")
    .required("Thiếu thông tin hoa hồng"),
